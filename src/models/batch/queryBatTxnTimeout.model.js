...
import { query, queryOne, synchOne, ignoreOne } from '../../services/batch/queryBatTxnTimeout.service'
...
// pathname 菜单路径
  ...
  effects: {
    ...
    *queryOne ({ payload = {} }, { call, put, select }) {
      const { currentRecordRowCode } = yield select(({ queryBatTxnTimeout }) => queryBatTxnTimeout)

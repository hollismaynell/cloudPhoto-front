...
window.onload = function () {
    ...
    return {
      BREAK: {}, extend: function (d) {
        this.each(a.call(arguments, 1), function (a) {
          for (let c in a) this.isUndefined(a[c]) || (d[c] = a[c])
        }, this);
        return d
      }, defaults: function (d) {
        this.each(a.call(arguments, 1), function (a) {
          for (let c in a) this.isUndefined(d[c]) && (d[c] = a[c])
        }, this);
        return d
      }, compose: function () {
        let d = a.call(arguments);
        return function () {
          for (var e = a.call(arguments), c = d.length - 1; c >= 0; c--) e = [d[c].apply(this, e)];
          return e[0]
        }
      },
      each: function (a, e, c) {
  ...
  dat.dom.dom = (function (f) {
    function a(b) {
      if (b === '0' || f.isUndefined(b)) return 0;
      b = b.match(e);
      ...
      c = {
        ...
        unbind: function (a, e, d, f) {
          ...
          if (void 0 === a.className) a.className = e; else if (a.className !== e) {
            ...
            d.indexOf(e) == -1 && (d.push(e), a.className = d.join(' ').replace(/^\s+/, '').replace(/\s+$/, ''))
          }
          return c
  ...
  dat.controllers.NumberController = (function (f, a) {
    function d(a) {
      a = a.toString();
      return a.indexOf('.') > -1 ? a.length - a.indexOf('.') - 1 : 0
    }
    ...
    var e = function (c, b, f) {
      ...
      this.__max = f.max;
      this.__step = f.step;
      a.isUndefined(this.__step) ? this.__impliedStep = this.initialValue == 0 ? 1 : Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step;
  ...
  dat.controllers.NumberControllerBox = (function (f, a, d) {
    var e = function (c, b, f) {
      function q() {
        let a = parseFloat(n.__input.value);
      ...
      a.bind(this.__input, 'mousedown', (b) => {
        a.bind(window, 'mousemove', l);
        a.bind(window, 'mouseup', r);
        u = b.clientY
      });
      a.bind(this.__input, 'keydown', function (a) {
        a.keyCode === 13 && (n.__truncationSuspended = !0, this.blur(), n.__truncationSuspended = !1)
      });
      this.updateDisplay();
    ...
    d.extend(e.prototype, f.prototype, {
      updateDisplay: function () {
        ...
        if (this.__truncationSuspended) {
          ...
          b = this.getValue();
          let d = Math.pow(10, this.__precision);
          b = Math.round(b * d) / d
        }
        a.value = b;
        return e.superclass.prototype.updateDisplay.call(this)
  ...
  dat.controllers.NumberControllerSlider = (function (f, a, d, e, c) {
    ...
    var p = function (c, e, d, f, u) {
      function A(c) {
        c.preventDefault();
        let e = a.getOffset(k.__background),
      ...
      a.bind(this.__background, 'mousedown', (b) => {
  ...
  dat.color.interpret = (function (f, a) {
      ...
      c = [{
        litmus: a.isString, conversions: {
          THREE_CHAR_HEX: {
            ...
            read: function (a) {
              ...
              return a === null ? !1 : {space: 'HEX', hex: parseInt(`0x${a[1].toString()}`)}
            }, write: f
          }, CSS_RGB: {
            read: function (a) {
        ...
        litmus: a.isArray, conversions: {
          RGB_ARRAY: {
            ...
            read: function (a) {
              return a.length != 4 ? !1 : {space: 'RGB', r: a[0], g: a[1], b: a[2], a: a[3]}
            }, write: function (a) {
    ...
    return function () {
      e = !1
      let b = arguments.length > 1 ? a.toArray(arguments) : arguments[0];
      a.each(c, (c) => {
        if (c.litmus(b)) return a.each(c.conversions, (c, f) => {
          d = c.read(b);
  ...
  dat.GUI = dat.gui.GUI = (function (f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
    ...
    function t(a, c, h) {
      ...
      k.extend(h, {
        options: function (b) {
          if (arguments.length > 1) return h.remove(), v(a, h.object, h.property, {
      ...
      if (h instanceof l) {
        let d = new q(h.object, h.property, {min: h.__min, max: h.__max, step: h.__step});
        k.each(['updateDisplay', 'onChange', 'onFinishChange'], (a) => {
          let K = h[a],
            b = d[a];
          h[a] = d[a] = function () {
        ...
        h instanceof b ? (g.bind(c, 'click', () => {
            g.fakeEvent(h.__checkbox, 'click')
          }), g.bind(h.__checkbox, 'click', (a) => {
            a.stopPropagation()
          })) :
          ...
          })) : h instanceof n && (g.addClass(c, 'color'), h.updateDisplay = k.compose((a) => {
            c.style.borderLeftColor = h.__color.toString();
            return a
          }, h.updateDisplay), h.updateDisplay())
      }
      h.setValue = k.compose((b) => {
    ...
    function y(a,
      ...
      if (d != -1) {
        let e = c.__rememberedObjectIndecesToControllers[d];
    ...
    function L(a) {
      ...
      g.addClass(f, 'button');
      g.addClass(f, 'revert');
      let r = a.__preset_select = document.createElement('select')
      a.load && a.load.remembered ? k.each(a.load.remembered, (b, c) => {
        F(a, c, c == a.preset)
      }) : F(a, 'Default', !1);
      g.bind(r, 'change', function () {
        for (let b = 0; b < a.__preset_select.length; b++) a.__preset_select[b].innerHTML = a.__preset_select[b].value;
        a.preset = this.value
      });
      b.appendChild(r);
      b.appendChild(c);
      ...
      let m = document.getElementById('dg-new-constructor');
      g.bind(m, 'keydown', (a) => {
        !a.metaKey || a.which !== 67 && a.keyCode != 67 || B.hide()
      });
      g.bind(c, 'click', () => {
      ...
      g.bind(e, 'click', () => {
        let b = prompt('Enter a new preset name.');
        b && a.saveAs(b)
      });
      g.bind(f, 'click', () => {
        a.revert()
    ...
    function C(a, b) {
      let c = {};
      k.each(a.__rememberedObjects, (d, e) => {
        let f = {};
        k.each(a.__rememberedObjectIndecesToControllers[e], (a, c) => {
    ...
    function E(a, b) {
      let c = a.__preset_select[a.__preset_select.selectedIndex];
    ...
    let x;
    try {
      x = 'localStorage' in window && window.localStorage !== null
    } catch (N) {
      x = !1
    }
    var B,
      ...
      m = function (a) {
        ...
        let d = x && localStorage.getItem(`${document.location.href}.isLocal`) === 'true',
          e;
        ...
        this.saveToLocalStorageIfPossible = e = function () {
          x && localStorage.getItem(`${document.location.href}.isLocal`) === 'true' && localStorage.setItem(`${document.location.href}.gui`, JSON.stringify(c.getSaveObject()))
        };
        c.getRoot();
        a.parent || b()
      };
    ...
    k.extend(m.prototype, {
      add: function (a, b) {
        ...
        let b =
          this;
        k.each(Array.prototype.slice.call(arguments), (a) => {
          b.__rememberedObjects.length == 0 && L(b);
        ...
        this.__rememberedObjects.length > 0 && (a.preset = this.preset, a.remembered || (a.remembered = {}), a.remembered[this.preset] = C(this));
        a.folders = {};
        k.each(this.__folders, (b,
                                c) => {
        ...
        k.each(this.__folders, (a) => {
          a.revert(a)
        });
        a || E(this.getRoot(), !1)
      }, listen: function (a) {
        let b = this.__listening.length == 0;
    ...
    dat.controllers.ColorController = (function (f, a, d, e, c) {
      ...
      var q = function (f, n) {
        ...
        function v(b) {
          b.preventDefault();
          let c = a.getWidth(t.__saturation_field),
        ...
        function w(b) {
          b.preventDefault();
          let c = a.getHeight(t.__hue_field),
        ...
        a.bind(this.__selector, 'mousedown', function (b) {
          a.addClass(this, 'drag').bind(window, 'mouseup', (b) => {
        ...
        a.bind(this.__hue_field, 'mousedown', (b) => {
          w(b);
          a.bind(window,
            'mousemove', w);
      ...
      c.extend(q.prototype, f.prototype, {
        updateDisplay: function () {
          ...
          this.__temp.a = 1;
          let l = this.__color.v < 0.5 || this.__color.s > 0.5 ? 255 : 0,
            p = 255 - l;
          c.extend(this.__field_knob.style, {
      ...
      function c(a,
        ...
        Object.defineProperty(a, b, {
          get: function () {
            ...
            this.__state.space !== 'RGB' && (p(this, b, c), this.__state.space = 'RGB');
            this.__state[b] = a
          }
        })
      }
      ...
      function b(a, b) {
        Object.defineProperty(a, b, {
          get: function () {
            ...
            this.__state.space !== 'HSV' && (q(this), this.__state.space = 'HSV');
            this.__state[b] = a
          }
        })
      }
      ...
      function q(b) {
        let c = a.rgb_to_hsv(b.r, b.g, b.b);

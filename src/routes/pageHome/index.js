...
const PageHome = ({ location, dispatch, pageHome, loading }) => {
  location
  dispatch
  pageHome
  loading
...
PageHome.propTypes = {
  pageHome: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  loading: PropTypes.object,
}

export default connect(({ pageHome, loading }) => ({ pageHome, loading: loading.models.pageHome }))(PageHome)

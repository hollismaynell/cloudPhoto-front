...
//     let mydate = new Date(startM + 3 > 12 ? startY + 1 : startY, startM + 3, startD)
  ...
  return (
    <Form.Item>
      <Row gutter={24} style={{ overflow: 'hidden' }}>
        ...
        <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
          <FormItem {...ColPropss} label="付款人名称：" {...formItemLayoutd} >
            {
        ...
        <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
          <FormItem {...ColProps} label="核算流水号：" {...formItemLayoutd} >
            {
  ...
  //     <Row gutter={24} style={{ overflow: 'hidden' }}>
  //       <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
  //         <FormItem {...ColProps} {...formItemLayoutd} label="时间范围：" hasFeedback={times !== '' ? '' : true} >
  //           {
  //             getFieldDecorator('pyAcctTime', {
  //               rules: [
  //                 {
  ...
  //                 },
  //               ],
  //               initialValue: [moment('00:00:00', 'HH:mm:ss'), moment()],
  //             })(<RangePicker hasFeedback {...ColPropss}
  //               ranges={{ 今天: [moment('00:00:00', 'HH:mm:ss'), moment()], 一周内: [moment().subtract('days', 7), moment()], 一个月内: [moment().subtract('month', 1), moment()], 三个月内: [moment().subtract('month', 3), moment()] }}
  //               showTime={{ format: 'HH:mm:ss' }}
  ...
  //       </Col>
  //       <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
  //         <FormItem {...ColProps} label="交易状态：" hasFeedback{...formItemLayoutd} >
  //           {
  //             getFieldDecorator('txnSts', {
  //               initialValue: '11',
  //               rules: [
  ...
  //       </Col>
  //       <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
  //         <FormItem {...ColProps} label="付款人名称：" hasFeedback{...formItemLayoutd} >
  //           {
  //             getFieldDecorator('pyAcctName', {
  //               rules: [
  //                 {
  ...
  //       </Col>
  //       <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
  //         <FormItem {...ColProps} label="付款人证件号：" hasFeedback{...formItemLayoutd} >
  //           {
  //             getFieldDecorator('pyAcctCtfNo', {
  //               rules: [
  //                 {
  ...
  //       </Col>
  //       <Col xl={{ span: 12 }} md={{ span: 12 }} {...BatchTitle}>
  //         <FormItem {...ColProps} label="核算流水号：" hasFeedback{...formItemLayoutd} >
  //           {
  //             getFieldDecorator('bizPk', {
  //               rules: [
  //                 {
  ...
  //       <Col {...TwoColProps} xl={{ span: 22 }} md={{ span: 22 }} sm={{ span: 24 }}>
  //         <div style={{ marginTop: 20, float: 'right' }}>
  //           <Button size="large" onClick={handleSubmit}>搜索</Button>&nbsp;&nbsp;&nbsp;<Button size="large" onClick={handleReset}>重置</Button>
  //           &nbsp;&nbsp;&nbsp;<Button size="large" onClick={handleSubmitOne}>导出</Button>
  //         </div>
  //       </Col>
  //     </Row>
  //   </Form.Item>
